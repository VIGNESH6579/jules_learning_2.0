...
-- Insert Courses
INSERT INTO courses (name, description, total_questions) VALUES
...
INSERT INTO questions (course_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation) VALUES
...
INSERT INTO coding_problems (title, description, difficulty, category, sample_input, sample_output, constraints) VALUES
...
-- Insert Tests
INSERT INTO tests (title, description, duration_minutes, total_questions, passing_score, is_active) VALUES
...
INSERT INTO test_results (user_id, test_id, score, total_questions, correct_answers, wrong_answers, skipped_questions, percentage, status, time_taken_seconds, started_at, completed_at) VALUES
...
SELECT 'Coding Problems inserted:' as info, COUNT(*) as count FROM coding_problems;
SELECT 'Tests inserted:' as info, COUNT(*) as count FROM tests;
SELECT 'Test Results inserted:' as info, COUNT(*) as count FROM test_results;
